...
--
-- TOC entry 257 (class 1255 OID 18111)
-- Name: best_product(); Type: FUNCTION; Schema: public; Owner: postgres
--

CREATE FUNCTION public.best_product() RETURNS integer
    LANGUAGE plpgsql
    AS $$
declare 
toplam integer;
begin 
return p.name,
SUM(od.quantity) from products p 
inner join product_suppliers ps on p.id = ps.product_id
inner join order_details od on ps.id = od.product_suppliers_id 
...
ALTER FUNCTION public.best_product() OWNER TO postgres;

--
-- TOC entry 255 (class 1255 OID 18106)
-- Name: date_diff(date, date, character varying); Type: FUNCTION; Schema: public; Owner: postgres
--

CREATE FUNCTION public.date_diff(date1 date, date2 date, year character varying) RETURNS integer
    LANGUAGE plpgsql
    AS $$
declare 
sonuc integer;
...
ALTER FUNCTION public.date_diff(date1 date, date2 date, year character varying) OWNER TO postgres;

--
-- TOC entry 258 (class 1255 OID 18124)
-- Name: get_best_product(integer); Type: FUNCTION; Schema: public; Owner: postgres
--

CREATE FUNCTION public.get_best_product(year integer) RETURNS TABLE(product_name character varying, product_sum bigint)
    LANGUAGE plpgsql
    AS $$     
BEGIN        
RETURN QUERY SELECT       
...
ALTER FUNCTION public.get_best_product(year integer) OWNER TO postgres;

--
-- TOC entry 254 (class 1255 OID 18105)
-- Name: sayitoplama(integer, integer); Type: FUNCTION; Schema: public; Owner: postgres
--

CREATE FUNCTION public.sayitoplama(sayi1 integer, sayi2 integer) RETURNS integer
    LANGUAGE plpgsql
    AS $$
declare 
sonuc integer;
...
ALTER FUNCTION public.sayitoplama(sayi1 integer, sayi2 integer) OWNER TO postgres;

--
-- TOC entry 256 (class 1255 OID 18110)
-- Name: urun_toplam(); Type: FUNCTION; Schema: public; Owner: postgres
--

CREATE FUNCTION public.urun_toplam() RETURNS integer
    LANGUAGE plpgsql
    AS $$
declare 
toplam integer;
...
ALTER FUNCTION public.urun_toplam() OWNER TO postgres;
...
--
-- TOC entry 252 (class 1259 OID 18112)
-- Name: product_category_view; Type: VIEW; Schema: public; Owner: postgres
--

CREATE VIEW public.product_category_view AS
 SELECT pc.category_id,
    ca.name,
    count(pc.product_id) AS "ürün adedi"
   FROM (public.product_categories pc
     JOIN public.categories ca ON ((pc.category_id = ca.id)))
  GROUP BY pc.category_id, ca.name
  ORDER BY (count(pc.product_id)) DESC;


ALTER TABLE public.product_category_view OWNER TO postgres;
...
--
-- TOC entry 253 (class 1259 OID 18120)
-- Name: product_supplier_view; Type: VIEW; Schema: public; Owner: postgres
--

CREATE VIEW public.product_supplier_view AS
 SELECT pr.name,
    sp.supplier_number,
    pr.unit_price,
    pr.stock,
   ...
   FROM ((public.product_suppliers ps
     JOIN public.products pr ON ((ps.product_id = pr.id)))
     JOIN public.suppliers sp ON ((sp.id = ps.supplier_id)));


ALTER TABLE public.product_supplier_view OWNER TO postgres;
...
--
-- TOC entry 3478 (class 0 OID 17617)
-- Dependencies: 214
...
--
-- TOC entry 3480 (class 0 OID 17623)
-- Dependencies: 216
...
--
-- TOC entry 3482 (class 0 OID 17629)
-- Dependencies: 218
...
--
-- TOC entry 3484 (class 0 OID 17633)
-- Dependencies: 220
...
--
-- TOC entry 3486 (class 0 OID 17639)
-- Dependencies: 222
...
--
-- TOC entry 3488 (class 0 OID 17645)
-- Dependencies: 224
...
--
-- TOC entry 3490 (class 0 OID 17651)
-- Dependencies: 226
...
--
-- TOC entry 3492 (class 0 OID 17657)
-- Dependencies: 228
...
--
-- TOC entry 3494 (class 0 OID 17663)
-- Dependencies: 230
...
--
-- TOC entry 3498 (class 0 OID 17671)
-- Dependencies: 234
...
--
-- TOC entry 3500 (class 0 OID 17677)
-- Dependencies: 236
...
--
-- TOC entry 3502 (class 0 OID 17683)
-- Dependencies: 238
...
--
-- TOC entry 3504 (class 0 OID 17687)
-- Dependencies: 240
...
--
-- TOC entry 3506 (class 0 OID 17691)
-- Dependencies: 242
...
--
-- TOC entry 3508 (class 0 OID 17697)
-- Dependencies: 244
...
--
-- TOC entry 3510 (class 0 OID 17703)
-- Dependencies: 246
...
--
-- TOC entry 3512 (class 0 OID 17709)
-- Dependencies: 248
...
--
-- TOC entry 3514 (class 0 OID 17715)
-- Dependencies: 250
...
--
-- TOC entry 3278 (class 2606 OID 17722)
...
--
-- TOC entry 3280 (class 2606 OID 17724)
...
--
-- TOC entry 3282 (class 2606 OID 17726)
...
--
-- TOC entry 3284 (class 2606 OID 17728)
...
--
-- TOC entry 3286 (class 2606 OID 17730)
...
--
-- TOC entry 3288 (class 2606 OID 17732)
...
--
-- TOC entry 3290 (class 2606 OID 17734)
...
--
-- TOC entry 3292 (class 2606 OID 17736)
...
--
-- TOC entry 3296 (class 2606 OID 17740)
...
--
-- TOC entry 3298 (class 2606 OID 17742)
...
--
-- TOC entry 3300 (class 2606 OID 17744)
...
--
-- TOC entry 3302 (class 2606 OID 17746)
...
--
-- TOC entry 3306 (class 2606 OID 17750)
...
--
-- TOC entry 3308 (class 2606 OID 17752)
...
--
-- TOC entry 3310 (class 2606 OID 17754)
...
--
-- TOC entry 3312 (class 2606 OID 17756)
...
--
-- TOC entry 3314 (class 2606 OID 17758)
...
--
-- TOC entry 3315 (class 2606 OID 17759)
...
--
-- TOC entry 3316 (class 2606 OID 17764)
...
--
-- TOC entry 3317 (class 2606 OID 17769)
...
--
-- TOC entry 3319 (class 2606 OID 17779)
...
--
-- TOC entry 3320 (class 2606 OID 17784)
...
--
-- TOC entry 3321 (class 2606 OID 17789)
...
--
-- TOC entry 3322 (class 2606 OID 17794)
...
--
-- TOC entry 3323 (class 2606 OID 17799)
...
--
-- TOC entry 3324 (class 2606 OID 17804)
...
--
-- TOC entry 3325 (class 2606 OID 17809)
...
--
-- TOC entry 3326 (class 2606 OID 17814)
...
--
-- TOC entry 3327 (class 2606 OID 17819)
...
--
-- TOC entry 3328 (class 2606 OID 17824)
...
--
-- TOC entry 3329 (class 2606 OID 17829)
...
--
-- TOC entry 3330 (class 2606 OID 17834)
...
--
-- TOC entry 3331 (class 2606 OID 17839)
...
--
-- TOC entry 3332 (class 2606 OID 17844)
...
--
-- TOC entry 3333 (class 2606 OID 17849)
